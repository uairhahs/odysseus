...
# Cookbook installs vllm/etc. via `uv add`, which pulls
...
#
# Checked layouts (all are real uv-wheel install paths):
...
# Make Cookbook-installed Python CLIs visible.
# vLLM and helper scripts land in /app/.local
