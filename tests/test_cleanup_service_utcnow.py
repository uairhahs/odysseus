"""Regression tests for the datetime.now(timezone.utc) removal in src/cleanup_service.py (#1116).
...
from src.cleanup_service import _now
...
def test_cutoff_math_stays_naive_and_comparable():
    ...
    # an aware _now() would raise when compared with the naive last_accessed column.
